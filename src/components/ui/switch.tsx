    ...
    return (
        ...
        >
            <SwitchPrimitive.Thumb
                ...
                className={cn(
                    "data-[state=unchecked]:bg-background data-[state=checked]:bg-primary pointer-events-none ml-0.5 block size-5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0",
                )}
            />
        </SwitchPrimitive.Root>
    );
