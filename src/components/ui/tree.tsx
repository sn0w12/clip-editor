...
export function Tree({
    ...
    return (
        <ul
            role="tree"
            className={cn(
                "m-0 list-none space-y-0.5 p-0", // less vertical spacing
                className,
            )}
            {...props}
        >
            ...
            >
                {showCollapse ? (
                    <Button
                        ...
                        tabIndex={-1}
                        className={cn(
                            "h-4 w-4 min-w-0 shrink-0 rounded p-0", // smaller button and icon
                        )}
                    >
                        {collapsed ? (
...
export function TreeChildren({
    ...
    return (
        <ul
            role="group"
            className={cn(
                "border-muted mt-0.5 ml-2 space-y-0.5 border-l pl-2", // less indent and spacing
                className,
            )}
            {...props}
        >
